...
import { RejectGroupPostCommand } from "./reject-group-post.command"

@CommandHandler(RejectGroupPostCommand)
export class RejectGroupPostHandler {
  constructor(
    private readonly groupRepository: IGroupRepository,
    private readonly userRepository: IUserRepository,
  ) {}
  async execute(command: RejectGroupPostCommand) {
    ...
    try {
      ...
      groupPost.status = EGroupPostStatus.DECLINED
