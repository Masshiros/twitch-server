  ...
  user: {
    setStreamKey: {
      badRequest: [
        ...
        "Stream key can not be empty",
        "Server url can not be empty",
      ],
      notFound: ["User not found"],
    },
    getStreamKey: {
  ...
  groups: {
    ...
    createScheduledGroupPost: {
      badRequest: [
        ...
        "Please provide day when the post should be created",
        "Cannot create post",
      ],
      notFound: [
        "User not found",
    ...
    acceptRequest: {
      badRequest: [
        "User id can not be empty",
        "Request user id can not be empty",
        "Group id can not be empty",
      ...
      notFound: [
        ...
        "You have not requested to join this group",
      ],
    },
    rejectRequest: {
      badRequest: [
